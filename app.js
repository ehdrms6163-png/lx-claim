...
function openPolicyModal(id){
  ...
  const ffrom=$('pm-f-from');if(ffrom)ffrom.value=p.from||'';
  const fto=$('pm-f-to');if(fto)fto.value=p.to||'';
...
function renderGlobalSearch(){
  ...
  const matchedMinor=minorClaims.filter(m=>(
